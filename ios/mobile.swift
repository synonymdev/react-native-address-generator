...
public func getPrivateKey(mnemonic: String, derivationPath: String, networkType: String, bip39Passphrase: String) -> [String] {
    return try! FfiConverterSequenceString.lift(
        try! rustCall {
            uniffi_mobile_fn_func_get_private_key(
                FfiConverterString.lower(mnemonic),
                FfiConverterString.lower(derivationPath),
                FfiConverterString.lower(networkType),
                FfiConverterString.lower(bip39Passphrase), $0
...
public func getScriptHash(address: String, network: String) -> [String] {
    return try! FfiConverterSequenceString.lift(
        try! rustCall {
            uniffi_mobile_fn_func_get_script_hash(
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_mobile_checksum_func_get_script_hash() != 41679 {
        return InitializationResult.apiChecksumMismatch
    }
