...
RustBuffer uniffi_mobile_fn_func_get_script_hash(RustBuffer address, RustBuffer network, RustCallStatus *_Nonnull out_status
);
...
uint16_t uniffi_mobile_checksum_func_get_address(void
    
);
uint16_t uniffi_mobile_checksum_func_get_private_key(void
    
);
uint16_t uniffi_mobile_checksum_func_get_script_hash(void
