...
internal interface _UniFFILib : Library {
    ...
    fun uniffi_mobile_fn_func_get_address(`mnemonic`: RustBuffer.ByValue,`derivationPath`: RustBuffer.ByValue,`networkType`: RustBuffer.ByValue,`bip39Passphrase`: RustBuffer.ByValue,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
...
fun `getAddress`(`mnemonic`: String, `derivationPath`: String, `networkType`: String, `bip39Passphrase`: String): List<String> {
    return FfiConverterSequenceString.lift(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_mobile_fn_func_get_address(FfiConverterString.lower(`mnemonic`),FfiConverterString.lower(`derivationPath`),FfiConverterString.lower(`networkType`),FfiConverterString.lower(`bip39Passphrase`),_status)
})
}


fun `getPrivateKey`(`mnemonic`: String, `derivationPath`: String, `networkType`: String, `bip39Passphrase`: String): List<String> {
    return FfiConverterSequenceString.lift(
    rustCall() { _status ->
...
fun `getScriptHash`(`address`: String, `network`: String): List<String> {
    return FfiConverterSequenceString.lift(
    rustCall() { _status ->
